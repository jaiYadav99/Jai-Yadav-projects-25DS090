...
responses = {
    ...
    "your name": ["My name is jai!", "you can call me jai!", "i'm jai,your assistant"],
    "bye": ["Goodbye", "See you later!", "bye!"],
    "my beautiful sister name": ["Jheel"],
    "what is my name": ["Jai"],
    "what is my mother name":["Indu"],
    "what is my father name": ["Jogender"],
    "my fav color":["Red"],
    "Good":["Thanks buddy"],
